...
const InfoPer = () => {
    ...
    return (
        <div align="center">
            <h2 className="tituloPrincipal">INFORMACION PERSONAL PERSONAJE SELECCIONADO</h2>
            <h1>{val}</h1>
            ...
            <Alert.Heading>
                Presentando informacion personal usuario
            </Alert.Heading>
                <p>
                ...
                <hr/>
                <p className="mb-0">
                    el usuario que has seleccionado es: {nombre}
                </p>
